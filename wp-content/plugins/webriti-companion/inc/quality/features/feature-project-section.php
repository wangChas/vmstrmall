	...
	//Upgrade to Pro
		...
		*/
		...
		?>
		 ...
		 <P><?php _e('Want to add more project and use animation effect in slider? Then upgrade to Pro.','webriti-companion');?></P>
		 </div>
		  <div class="pro-box">
		 <a href="<?php echo esc_url('http://webriti.com/quality/');?>" class="service" id="review_pro" target="_blank"><?php _e('Upgrade to Pro','webriti-companion' ); ?></a>
		 </div>
		<?php
		}
		}
